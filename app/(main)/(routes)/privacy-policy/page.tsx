    ...
    <section>
      <Container className="max-w-[1000px] mt-[150px] flex flex-col gap-y-3 pb-24 lg:pb-0 px-10">
        ...
        <p>
          ...
          by eroskarm.com and how we use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in eroskarm.com. This policy is not applicable
          to any information collected offline or via channels other than this
          website.
        </p>

        <h2 className="text-2xl font-bold mt-8">Consent</h2>
        ...
        <p>
          ...
          advertising partners of eroskarm.com.
        </p>
        ...
        <p>
          Note that eroskarm.com has no access to or control over these cookies
        ...
        <p>
          eroskarm.com does not knowingly collect any Personal Identifiable
